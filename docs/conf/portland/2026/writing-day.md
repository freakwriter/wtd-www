...
To get the most out of the session, you should already roughly know what a pull request is, have encountered docs-as-code before. Our table can help with getting a documentation site running locally so you can preview your changes. If you are totally new to GitHub, no fear! Go to one of the New to Git and GitHub workshops and then come join us after. We'll help you immediately apply what you just learned.
...
### Improve how AI sees your docs: Putting the Agent-Friendly Doc Spec (AFDocs) into practice 
