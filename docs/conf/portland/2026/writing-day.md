...
- **Morning Session**
  ...
  - Project announcements: Leads give a one-minute summary and projects begin
  - GitHub workshops
  - Resume writing and portfolio review session
- **Lunch Break**
- **Afternoon Session**
  - Project announcements: Leads give a one-minute summary, starting with the afternoon-only projects, and projects reconvene
  - GitHub workshop
  - Resume writing and portfolio review session
